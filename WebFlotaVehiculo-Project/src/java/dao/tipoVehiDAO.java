...
public class tipoVehiDAO {
    ...
    public static String getTipoVehi(int id) {
        String sql = "SELECT nomtv FROM tipo_vehiculo WHERE idtv = ?";
    ...
    // Método alternativo que funciona con ambas estructuras de tabla
    public static String getTipoVehiAlternativo(int IdTV){
        try {
            String sqlTvForVehi = "SELECT nomtv FROM tipo_vehiculo WHERE idtv=?";
            Connection conex = conexionLib.conectarnosBD();
