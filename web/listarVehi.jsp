													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="vehiControlador?accion=editar&placavehi=<%= v.getPlacavehi() %>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>
<a class="red" href="vehiControlador?accion=eliminar&placavehi=<%= v.getPlacavehi() %>" onclick="return confirm('¿Seguro que desea eliminar este vehículo?');">
